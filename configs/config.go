...
func NewConfig() *Config {
	return &Config{
		...
		MusicPostgresBD:         "host=music-bd port=5432 user=andrewkireev dbname=music_serv password=password sslmode=disable",
		ProfilesServerAddr:      "8082",
		ProfileDB:               "host=music-bd port=5432 user=andrewkireev dbname=music_serv password=password sslmode=disable",
		LogLevel:                "debug",
